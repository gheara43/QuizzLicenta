...
class QuizzWidget extends StatefulWidget {
  const QuizzWidget({
    super.key,
    required this.jsonQuestions,
    int? questionNumber,
    required this.title,
  }) : this.questionNumber = questionNumber ?? 0;

  final dynamic jsonQuestions;
  final int questionNumber;
  final String? title;

  static String routeName = 'Quizz';
  static String routePath = '/quizz';
...
class _QuizzWidgetState extends State<QuizzWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.questionsList = (widget.jsonQuestions!
              .toList()
              .map<QuestionDataTypeStruct?>(QuestionDataTypeStruct.maybeFromMap)
              .toList() as Iterable<QuestionDataTypeStruct?>)
          .withoutNulls
          .toList()
